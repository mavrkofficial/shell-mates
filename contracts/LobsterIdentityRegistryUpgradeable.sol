...
/**
 * @title LobsterIdentityRegistryUpgradeable
 * @notice ERC-8004–compatible Identity Registry for Lobster Tinder hackathon.
 * @dev Same logic as erc-8004 IdentityRegistryUpgradeable but with a first-time `initialize(address)`
 *      suitable for direct UUPS proxy deployment (upstream uses reinitializer/onlyOwner for vanity upgrade path).
 */
contract LobsterIdentityRegistryUpgradeable is
    ...
    EIP712Upgradeable
{
    ...
    function initialize(address initialOwner) external initializer {
        __ERC721_init("LobsterAgent", "CLAW");
